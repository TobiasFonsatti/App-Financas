          ...
          child: Padding(
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(
                    color: Colors.green.withValues(alpha: widget.isDarkMode ? 0.05 : 0.25),
                    blurRadius: 12,
                      ...
                      child: Column(
                        children: [
                          Row(
                            ...
                            children: [
                              const Icon(Icons.arrow_circle_up, color: Color(0xFF4ADE80), size: 22),
                              const SizedBox(width: 8),
                              Text('Receitas', style: TextStyle(
                                color: widget.isDarkMode
                      ...
                      child: Column(
                        children: [
                          Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.arrow_circle_down, color: Colors.red.shade400, size: 22),
                              const SizedBox(width: 8),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 20,
                fontWeight: FontWeight.bold,
                color: widget.isDarkMode ? const Color(0xFF86EFAC) : Colors.black87,
              ),
            ),
            const SizedBox(height: 12),
            Card(
                ...
                child: SizedBox(
                  ...
                  child: Builder(
                    builder: (context) {
                      ...
                      final String incomePercentage = totalSum == 0 ? '0%' : '${((totalIncome / totalSum) * 100).toStringAsFixed(0)}%';
                      final String expensePercentage = totalSum == 0 ? '0%' : '${((totalExpense / totalSum) * 100).toStringAsFixed(0)}%';
              ...
              itemBuilder: (context, index) {
                ...
                return ListTile(
                  title: Text(
                    ...
                    style: TextStyle(
                      color: widget.isDarkMode ? const Color(0xFF86EFAC) : null,
                    ),
                  ),
                  subtitle: Text(
                    transaction['date'],
